const TaxSoftwarehost = ()=>{
    return(
        <div className="">
        <h2 className="text-lg font-bold mb-2 underline">Tax Software Host</h2>
        <div className="flex space-x-4 mb-2">
          <button className="border px-4 py-2 rounded font-bold">
            <span className="text-blue-400 text-lg">Tax </span> Tax Software Hosting
          </button>
          <button className="border px-4 py-2 rounded font-bold">
            <span className="text-blue-400 text-lg">Tax </span> Tax Enterprise Hosting
          </button>
        </div>
...
export default TaxSoftwarehost;